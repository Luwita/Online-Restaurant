        ...
        <div className="relative">
          ...
          <div className="fixed top-4 right-4 z-50 flex flex-col space-y-2">
            <button
              ...
              className="p-3 bg-white/10 backdrop-blur-xl text-white rounded-full shadow-lg hover:bg-white/20 transition-all duration-200 border border-white/20"
          ...
          <button
            ...
            className="fixed bottom-4 right-4 z-40 p-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
